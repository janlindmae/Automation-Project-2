class IssueModal {
  ...
  selectIssueType(issueType) {
    ...
    cy.get('[data-testid="icon:close"]').trigger("click"); //This is needed for when user needs type "Task" but it is already selected by default and not visible on the list
